...
function xg_product_slider_vc_map_register_callback($settings,$value){
	$args = array(
	...
	$markup = '<div class="xportfolio-category-select-options">'
	          ...
	          '<option value="">'.esc_html('Select Shortcode','xg-product').'</option>';
	if ($allshortcode) {
...
vc_add_shortcode_param( 'xg_product_slider' , 'xg_product_slider_vc_map_register_callback' );
